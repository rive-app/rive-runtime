#ifndef _RIVE_VIEW_MODEL_INSTANCE_ASSET_BASE_HPP_
#define _RIVE_VIEW_MODEL_INSTANCE_ASSET_BASE_HPP_
...
namespace rive
{
class ViewModelInstanceAssetBase : public ViewModelInstanceValue
{
protected:
    typedef ViewModelInstanceValue Super;

public:
    static const uint16_t typeKey = 586;
    ...
    static const uint16_t propertyValuePropertyKey = 824;
...
public:
    ...
    void copy(const ViewModelInstanceAssetBase& object)
    {
...
#ifdef WITH_RIVE_EDITOR
#include "editor_native/generated/viewmodel/viewmodel_instance_asset_ext.inl"
#endif
};
} // namespace rive
