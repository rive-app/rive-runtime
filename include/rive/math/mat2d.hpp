...
public:
    ...
    // Computes a bounding box that would tightly contain the given points if
    // they were to all be transformed by this matrix, ignoring NaN values.
