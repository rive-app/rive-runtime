...
rive::Span<const uint32_t> loadNewShaderFileData()
{
    ...
    std::filesystem::path spirvFileNames[] = {
        ...
        riveSpirvPath /
            "draw_depthstencil_triangles_nocolor.fixedcolor_frag.spv",
        riveSpirvPath / "draw_depthstencil_atlas_blit.vert.spv",
        riveSpirvPath / "draw_depthstencil_atlas_blit.noclipdistance_vert.spv",
        riveSpirvPath / "draw_depthstencil_atlas_blit.frag.spv",
        riveSpirvPath / "draw_depthstencil_atlas_blit.fixedcolor_frag.spv",
        riveSpirvPath / "draw_depthstencil_atlas_blit.msaa_frag.spv",
        riveSpirvPath / "draw_depthstencil_image_mesh.vert.spv",
        riveSpirvPath / "draw_depthstencil_image_mesh.noclipdistance_vert.spv",
        riveSpirvPath / "draw_depthstencil_image_mesh.frag.spv",
        riveSpirvPath / "draw_depthstencil_image_mesh.fixedcolor_frag.spv",
        riveSpirvPath / "draw_depthstencil_image_mesh.msaa_frag.spv",
