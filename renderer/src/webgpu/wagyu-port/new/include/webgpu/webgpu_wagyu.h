...
#define WGPU_WAGYU_ADAPTER_INFO_INIT                                           \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/*.chain*/ WGPU_WAGYU_CHAIN_INIT(WGPUSType_WagyuAdapterInfo)          \
...
#define WGPU_WAGYU_COMPUTE_PIPELINE_DESCRIPTOR_INIT                            \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/*.chain*/ WGPU_WAGYU_CHAIN_INIT(                                     \
            WGPUSType_WagyuComputePipelineDescriptor)                          \
             _wgpu_COMMA /*.cacheKey*/ WGPU_STRING_VIEW_INIT _wgpu_COMMA})
...
#define WGPU_WAGYU_DEVICE_DESCRIPTOR_INIT                                      \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/*.chain*/ WGPU_WAGYU_CHAIN_INIT(WGPUSType_WagyuDeviceDescriptor)     \
             _wgpu_COMMA /*.dataBufferNeedsDetach*/ WGPU_TRUE _wgpu_COMMA})
...
#define WGPU_WAGYU_DEVICE_PIPELINE_BINARY_CACHE_KEY_INIT                       \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/*.cacheKey*/ WGPU_STRING_VIEW_INIT                                   \
...
#define WGPU_WAGYU_EXTERNAL_TEXTURE_DESCRIPTOR_INIT                            \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/*nextInChain = */ NULL _wgpu_COMMA       /*label = */                \
             WGPU_STRING_VIEW_INIT _wgpu_COMMA     /*source = */               \
                 WGPU_STRING_VIEW_INIT _wgpu_COMMA /*colorSpace = */           \
                     WGPUPredefinedColorSpace_SRGB _wgpu_COMMA})
    ...
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/* .name */ WGPU_STRING_VIEW_INIT                                     \
         ...
         0 _wgpu_COMMA /* .type */ 0 _wgpu_COMMA    /* .imageMultisampled */   \
             WGPU_FALSE _wgpu_COMMA                 /* .imageDimension */      \
                 WGPUTextureViewDimension_Undefined                            \
                     _wgpu_COMMA /* .imageFormat */                            \
...
#define WGPU_WAGYU_SHADER_REFLECTION_LOCATION_INIT                             \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/* .name */ WGPU_STRING_VIEW_INIT _wgpu_COMMA /* .location */         \
...
#define WGPU_WAGYU_SHADER_REFLECTION_RESOURCE_INIT                             \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/* .name */ WGPU_STRING_VIEW_INIT                                     \
             _wgpu_COMMA /* .group */ 0 _wgpu_COMMA     /* .binding */         \
         0 _wgpu_COMMA /* .bindingType */ 0 _wgpu_COMMA /* .multisampled */    \
             WGPU_FALSE _wgpu_COMMA                     /* .dimension */       \
                 WGPUTextureViewDimension_Undefined                            \
...
#define WGPU_WAGYU_SHADER_REFLECTION_SPECIALIZATION_CONSTANT_INIT              \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/* .id */ 0 _wgpu_COMMA /* .internalId */ 0 _wgpu_COMMA /* .type */   \
         0 _wgpu_COMMA /* .name */ WGPU_STRING_VIEW_INIT _wgpu_COMMA})
        ...
        {/* .resourceCount */ 0 _wgpu_COMMA /* .resources */ NULL              \
         ...
         0 _wgpu_COMMA /* .uniforms */ NULL                                    \
             _wgpu_COMMA /* .attributeCount */ 0 _wgpu_COMMA /* .attributes */ \
                 NULL _wgpu_COMMA /* .wgsl */ WGPU_STRING_VIEW_INIT            \
                     _wgpu_COMMA})
...
#define WGPU_WAGYU_SHADER_ENTRY_POINT_INIT                                     \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/* .entryPoint */ WGPU_STRING_VIEW_INIT _wgpu_COMMA /* .stage */      \
             WGPUShaderStage_NONE _wgpu_COMMA                /* .reflection */ \
...
#define WGPU_WAGYU_SHADER_MODULE_COMPILATION_HINT_INIT                         \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/* .nextInChain */ NULL _wgpu_COMMA /* .entryPoint */                 \
             WGPU_STRING_VIEW_INIT _wgpu_COMMA /* .layout */ NULL              \
                 _wgpu_COMMA})
...
#define WGPU_WAGYU_TEXTURE_DESCRIPTOR_INIT                                     \
    WGPU_WAGYU_MAKE_INIT_STRUCT(                                               \
        ...
        {/*.chain = */ WGPU_WAGYU_CHAIN_INIT(WGPUSType_WagyuTextureDescriptor) \
             _wgpu_COMMA /*.useSurfaceCache = */ WGPU_TRUE _wgpu_COMMA})
...
extern "C"
{
    ...
    WGPU_EXPORT void wgpuWagyuAdapterGetGraphicsReport(
        WGPUAdapter adapter,
        WGPUStringView* graphicsReport) WGPU_FUNCTION_ATTRIBUTE;
    ...
    WGPU_EXPORT void wgpuWagyuDeviceGetExtensions(
        WGPUDevice device,
        WGPUWagyuStringArray* extensions) WGPU_FUNCTION_ATTRIBUTE;
    WGPU_EXPORT WGPUFuture wgpuWagyuDeviceFlush(
        WGPUDevice device,
        WGPUWagyuDeviceFlushCallbackInfo callbackInfo) WGPU_FUNCTION_ATTRIBUTE;
    ...
    WGPU_EXPORT void wgpuWagyuExternalTextureAddRef(
    ...
    WGPU_EXPORT void wgpuWagyuRelaxedComplianceAddRef(
