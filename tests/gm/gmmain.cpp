...
#define MAKE_PARITY_GM3(NAME, IMM, VAR1, VAR2)                                 \
    ...
    MAKE_GM(clip_stroke_basic)
    MAKE_GM(clip_stroke_nested_a)
    MAKE_GM(clip_stroke_nested_b)
    MAKE_GM(clip_stroke_nested_c)
    MAKE_GM(clip_stroke_open)
    MAKE_GM(clip_stroke_position)
    ...
    MAKE_GM(rect)
    MAKE_GM(rect_grad)
    MAKE_GM(retrofitcubictristrips)
    MAKE_GM(roundjoinstrokes)
    MAKE_GM(strokedlines)
    MAKE_GM(strokefill)
    MAKE_GM(stroke_position)
    MAKE_GM(stroke_position_clipped)
    MAKE_GM(bug339297)
    ...
    MAKE_GM(ore_mrt)
    MAKE_GM(ore_depth)
    MAKE_GM(ore_depth_write_always)
    MAKE_GM(ore_cubemap)
