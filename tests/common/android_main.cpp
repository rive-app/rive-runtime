...
extern int rive_android_main(int argc, const char* const* argv, android_app* app);
...
extern "C" JNIEXPORT void JNICALL android_main(android_app* app)
{
    ...
    jmethodID getIntentFn =
        env->GetMethodID(activityClass, "getIntent", "()Landroid/content/Intent;");
    jobject intent = env->CallObjectMethod(javaActivity, getIntentFn);

    // ... .getExtras()
    jclass intentClass = env->FindClass("android/content/Intent");
    jmethodID getExtrasFn = env->GetMethodID(intentClass, "getExtras", "()Landroid/os/Bundle;");
    ...
    jmethodID getStringFn =
        env->GetMethodID(bundleClass, "getString", "(Ljava/lang/String;)Ljava/lang/String;");
    jstring args =
        static_cast<jstring>(env->CallObjectMethod(extras, getStringFn, env->NewStringUTF("args")));
